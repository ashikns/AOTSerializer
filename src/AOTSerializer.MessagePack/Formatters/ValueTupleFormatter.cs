...
namespace AOTSerializer.MessagePack.Formatters
{
    ...
    {
        public override int Serialize(ref byte[] bytes, int offset, ValueTuple<T1> value, IResolver resolver)
        {
        ...
        public override ValueTuple<T1> Deserialize(byte[] bytes, int offset, out int readSize, IResolver resolver)
        {
    ...
    {
        public override int Serialize(ref byte[] bytes, int offset, ValueTuple<T1, T2> value, IResolver resolver)
        {
            var startOffset = offset;
        ...
        public override ValueTuple<T1, T2> Deserialize(byte[] bytes, int offset, out int readSize, IResolver resolver)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("Data is Nil, ValueTuple can not be null.");
    ...
    {
        public override int Serialize(ref byte[] bytes, int offset, ValueTuple<T1, T2, T3> value, IResolver resolver)
        {
            var startOffset = offset;
        ...
        public override ValueTuple<T1, T2, T3> Deserialize(byte[] bytes, int offset, out int readSize, IResolver resolver)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("Data is Nil, ValueTuple can not be null.");
    ...
    {
        public override int Serialize(ref byte[] bytes, int offset, ValueTuple<T1, T2, T3, T4> value, IResolver resolver)
        {
            var startOffset = offset;
        ...
        public override ValueTuple<T1, T2, T3, T4> Deserialize(byte[] bytes, int offset, out int readSize, IResolver resolver)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("Data is Nil, ValueTuple can not be null.");
    ...
    {
        public override int Serialize(ref byte[] bytes, int offset, ValueTuple<T1, T2, T3, T4, T5> value, IResolver resolver)
        {
            var startOffset = offset;
        ...
        public override ValueTuple<T1, T2, T3, T4, T5> Deserialize(byte[] bytes, int offset, out int readSize, IResolver resolver)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("Data is Nil, ValueTuple can not be null.");
    ...
    {
        public override int Serialize(ref byte[] bytes, int offset, ValueTuple<T1, T2, T3, T4, T5, T6> value, IResolver resolver)
        {
            var startOffset = offset;
        ...
        public override ValueTuple<T1, T2, T3, T4, T5, T6> Deserialize(byte[] bytes, int offset, out int readSize, IResolver resolver)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("Data is Nil, ValueTuple can not be null.");
    ...
    {
        public override int Serialize(ref byte[] bytes, int offset, ValueTuple<T1, T2, T3, T4, T5, T6, T7> value, IResolver resolver)
        {
            var startOffset = offset;
        ...
        public override ValueTuple<T1, T2, T3, T4, T5, T6, T7> Deserialize(byte[] bytes, int offset, out int readSize, IResolver resolver)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("Data is Nil, ValueTuple can not be null.");
    ...
    {
        public override int Serialize(ref byte[] bytes, int offset, ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> value, IResolver resolver)
        {
            var startOffset = offset;
        ...
        public override ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> Deserialize(byte[] bytes, int offset, out int readSize, IResolver resolver)
        {
            if (MessagePackBinary.IsNil(bytes, offset))
            {
                throw new InvalidOperationException("Data is Nil, ValueTuple can not be null.");
