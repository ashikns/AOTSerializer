...
namespace AOTSerializer.MessagePack
{
    ...
    public static partial class MessagePackBinary
    {
        ...
        public static int WriteRaw(ref byte[] bytes, int offset, byte[] rawMessagePackBlock)
        {
            ...
            UnsafeMemory.WriteRaw(ref bytes, ref resultOffset, rawMessagePackBlock);
            return resultOffset - offset;
        }
                ...
                case MessagePackType.Integer:
                    {
                        ...
                        BinaryUtil.EnsureCapacity(ref bytes, offset, readCount + 1);
                ...
                case MessagePackType.String:
                    {
                        if (MessagePackCode.MinFixStr <= code && code <= MessagePackCode.MaxFixStr)
                        {
                            ...
                            BinaryUtil.EnsureCapacity(ref bytes, offset, 1 + length);
                            ...
                            case MessagePackCode.Str8:
                                {
                                    ...
                                    BinaryUtil.EnsureCapacity(ref bytes, offset, 2 + length);
                            ...
                            case MessagePackCode.Str16:
                                {
                                    ...
                                    BinaryUtil.EnsureCapacity(ref bytes, offset, 3 + length);
                            ...
                            case MessagePackCode.Str32:
                                {
                                    ...
                                    BinaryUtil.EnsureCapacity(ref bytes, offset, 5 + length);
                ...
                case MessagePackType.Array:
                    {
                        ...
                        if (readHeaderSize != 0)
                        {
                            BinaryUtil.EnsureCapacity(ref bytes, offset, readHeaderSize + 1);
                ...
                case MessagePackType.Extension:
                    {
                        ...
                        if (!readOnlySingleMessage)
                        {
                            ...
                            BinaryUtil.EnsureCapacity(ref bytes, offset, 1 + readHeaderSize + (int)header.Length);
