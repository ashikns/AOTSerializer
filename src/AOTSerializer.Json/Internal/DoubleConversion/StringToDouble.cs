...
namespace AOTSerializer.Json.Internal.DoubleConversion
{
    ...
    internal static class StringToDouble
    {
        ...
        private const uint64_t kMaxUint64 = 0xFFFFFFFFFFFFFFFF;
        ...
        private static uint64_t ReadUint64(Vector buffer,
